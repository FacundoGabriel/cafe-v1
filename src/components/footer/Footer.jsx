    ...
    <div className="container-fluid container-footer">
      <div className="row">
        <div className="col-12 col-md-4 col-lg-3 mb-4 text-center text-lg-start">
          <p data-aos="fade-right" className="footer-logo">Logo</p>
          <p data-aos="fade-right" className="footer-description">
        ...
        <div className="col-12 col-md-4 col-lg-3 mb-4 text-center">
          <h3 data-aos="fade-right" className="mb-4 mb-md-3">Redes</h3>
          <ul data-aos="fade-right" className="footer-social d-flex flex-column align-items-center">
            <li >
              <a
        ...
        <div data-aos="fade-right" className="col-12 col-md-4 col-lg-3 mb-4 footer-contacto text-center text-lg-start">
        ...
        <div data-aos="fade-right" className="col-12 col-md-4 col-lg-3 mb-4 footer-politicas text-center text-lg-start">
          <h3>Políticas</h3>
